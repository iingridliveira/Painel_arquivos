...
resource "aws_instance" "app_instance" {
  ami           = "ami-06fa3e561475dbbb4"  # AMI do Amazon Linux 2 (verifique se esta AMI está disponível na sua região)
  ...
  vpc_security_group_ids = [aws_security_group.allow_ssh_http.id]
    ...
    user_data = <<-EOF
              ...
              git clone https://github.com/iingridliveira/Painel_arquivos.git /app
